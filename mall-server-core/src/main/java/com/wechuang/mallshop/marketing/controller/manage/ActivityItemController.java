...
import com.wechuang.mallshop.marketing.model.req.ActivityItemAddReq;
import com.wechuang.mallshop.marketing.model.req.ActivityItemEditReq;
import com.wechuang.mallshop.marketing.model.req.ActivityItemListReq;
...
public class ActivityItemController extends BaseController {
    ...
    @Operation(summary = "参与活动商品表-用户筛选计算-分页列表查询", description = "参与活动商品表-用户筛选计算-分页列表查询")
    ...
    @Operation(summary = "参与活动商品表-用户筛选计算-通过activity_item_id查询", description = "参与活动商品表-用户筛选计算-通过activity_item_id查询")
    ...
    @Operation(summary = "参与活动商品表-用户筛选计算-添加", description = "参与活动商品表-用户筛选计算-添加")
    ...
    @Operation(summary = "参与活动商品表-用户筛选计算-编辑", description = "参与活动商品表-用户筛选计算-编辑")
    ...
    @Operation(summary = "参与活动商品表-用户筛选计算-通过activity_item_id删除", description = "参与活动商品表-用户筛选计算-通过activity_item_id删除")
    ...
    @Operation(summary = "参与活动商品表-用户筛选计算-批量删除", description = "参与活动商品表-用户筛选计算-批量删除")
