 ...
 * @since 2023-12-13
 */
public interface MqMessageService extends IBaseService<MqMessage, MqMessageListReq> {
    /**
     * mq发送消息
     */
    void sendMqMsg(String exchange, String routingKey, Object data);

    /**
     * mq批量发送消息
     */
    void sendBatchMqMsg(List<MqMessageVo> msgVos);
