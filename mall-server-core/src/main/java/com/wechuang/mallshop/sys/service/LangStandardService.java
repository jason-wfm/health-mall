 ...
 * @since 2024-07-15
 */
public interface LangStandardService extends IBaseService<LangStandard, LangStandardListReq> {

    /**
     * 语言翻译表-添加/编辑
     *
     * @param langStandardEditReq
     * @return
     */
    boolean saveOrUpdateStandard(LangStandardEditReq langStandardEditReq);
}
