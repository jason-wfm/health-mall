...
import com.wechuang.mallshop.sys.model.req.ContractTypeAddReq;
import com.wechuang.mallshop.sys.model.req.ContractTypeEditReq;
import com.wechuang.mallshop.sys.model.req.ContractTypeListReq;
import com.wechuang.mallshop.sys.model.req.ContractTypeStateEditReq;
import com.wechuang.mallshop.sys.service.ContractTypeService;
...
public class ContractTypeController extends BaseController {
    ...
    @Operation(summary = "消费者保障服务表-店铺加入-分页列表查询", description = "消费者保障服务表-店铺加入-分页列表查询")
    ...
    @Operation(summary = "消费者保障服务表-店铺加入-添加", description = "消费者保障服务表-店铺加入-添加")
    ...
    @Operation(summary = "消费者保障服务表-店铺加入-编辑", description = "消费者保障服务表-店铺加入-编辑")
    ...
    @Operation(summary = "消费者保障服务表-修改状态", description = "消费者保障服务表-修改状态")
    ...
    @Operation(summary = "消费者保障服务表-店铺加入-通过contract_type_id删除", description = "消费者保障服务表-店铺加入-通过contract_type_id删除")
