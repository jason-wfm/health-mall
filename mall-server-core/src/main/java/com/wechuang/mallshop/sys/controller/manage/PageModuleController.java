...
import com.wechuang.mallshop.sys.model.req.PageModuleAddReq;
import com.wechuang.mallshop.sys.model.req.PageModuleEditReq;
...
public class PageModuleController extends BaseController {
    ...
    @Operation(summary = "页面模块表-分页列表查询", description = "页面模块表-分页列表查询")
    ...
    @Operation(summary = "页面模块表-通过pm_id查询", description = "页面模块表-通过pm_id查询")
    ...
    @PreAuthorize("hasAuthority('/manage/sys/diy/index')")
    @Operation(summary = "页面模块表-添加", description = "页面模块表-添加")
    ...
    public CommonRes<?> add(PageModuleAddReq pageModuleAddReq) {
        ...
        long count = pageModuleService.count(new LambdaQueryWrapper<PageModule>().eq(PageModule::getPageId, pageModule.getPageId()));
        pageModule.setPmOrder((int) count);
    ...
    @PreAuthorize("hasAuthority('/manage/sys/diy/index')")
    @Operation(summary = "页面模块表-编辑", description = "页面模块表-编辑")
    ...
    @PreAuthorize("hasAuthority('/manage/sys/diy/index')")
    @Operation(summary = "页面模块表-通过pm_id删除", description = "页面模块表-通过pm_id删除")
    ...
    @PreAuthorize("hasAuthority('/manage/sys/diy/index')")
    @Operation(summary = "PC楼层模板", description = "PC楼层模板")
    ...
    @PreAuthorize("hasAuthority('/manage/sys/diy/index')")
    @Operation(summary = "页面模块表-启用、禁用", description = "页面模块表-启用、禁用")
    ...
    @PreAuthorize("hasAuthority('/manage/sys/diy/index')")
    @Operation(summary = "页面模块表-拖动", description = "页面模块表-拖动")
