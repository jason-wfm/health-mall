...
import com.wechuang.mallshop.sys.model.entity.PageMobileNav;
import com.wechuang.mallshop.sys.model.req.PageMobileNavAddReq;
import com.wechuang.mallshop.sys.model.req.PageMobileNavEditReq;
import com.wechuang.mallshop.sys.model.req.PageMobileNavListReq;
import com.wechuang.mallshop.sys.service.PageMobileNavService;
...
public class PageMobileNavController extends BaseController {
    ...
    @Operation(summary = "移动端首页分类使用-分页列表查询", description = "移动端首页分类使用-分页列表查询")
    ...
    @PreAuthorize("hasAuthority('/manage/sys/diy/index')")
    @Operation(summary = "移动端首页分类使用-添加", description = "移动端首页分类使用-添加")
    ...
    @PreAuthorize("hasAuthority('/manage/sys/diy/index')")
    @Operation(summary = "移动端首页分类使用-编辑", description = "移动端首页分类使用-编辑")
    ...
    @PreAuthorize("hasAuthority('/manage/sys/diy/index')")
    @Operation(summary = "移动端首页分类使用-通过category_id删除", description = "移动端首页分类使用-通过category_id删除")
