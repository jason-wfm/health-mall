...
import com.wechuang.mallshop.sys.model.req.MessageTemplateAddReq;
import com.wechuang.mallshop.sys.model.req.MessageTemplateEditReq;
import com.wechuang.mallshop.sys.model.req.MessageTemplateEnableEditReq;
import com.wechuang.mallshop.sys.model.req.MessageTemplateListReq;
...
public class MessageTemplateController extends BaseController {
    ...
    @Operation(summary = "消息模板表-通过message_id查询", description = "消息模板表-通过message_id查询")
    ...
    @Operation(summary = "消息模板表-添加", description = "消息模板表-添加")
    ...
    @Operation(summary = "消息模板表-编辑", description = "消息模板表-编辑")
    ...
    @Operation(summary = "消息模板表-修改通知", description = "消息模板表-修改通知")
    ...
    @Operation(summary = "消息模板表-通过message_id删除", description = "消息模板表-通过message_id删除")
