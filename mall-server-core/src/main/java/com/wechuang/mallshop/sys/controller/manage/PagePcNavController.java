...
import com.wechuang.mallshop.sys.model.req.PagePcNavAddReq;
import com.wechuang.mallshop.sys.model.req.PagePcNavEditReq;
import com.wechuang.mallshop.sys.model.req.PagePcNavListReq;
import com.wechuang.mallshop.sys.model.req.PagePcNavStateEditReq;
import com.wechuang.mallshop.sys.service.PagePcNavService;
...
public class PagePcNavController extends BaseController {
    ...
    @Operation(summary = "页面导航表-分页列表查询", description = "页面导航表-分页列表查询")
    ...
    @PreAuthorize("hasAuthority('/manage/sys/diy/index')")
    @Operation(summary = "页面导航表-添加", description = "页面导航表-添加")
    ...
    @PreAuthorize("hasAuthority('/manage/sys/diy/index')")
    @Operation(summary = "页面导航表-编辑", description = "页面导航表-编辑")
    ...
    @PreAuthorize("hasAuthority('/manage/sys/diy/index')")
    @Operation(summary = "页面导航表-通过nav_id删除", description = "页面导航表-通过nav_id删除")
