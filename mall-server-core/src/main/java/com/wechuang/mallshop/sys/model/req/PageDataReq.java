...
@Schema(description = "页面内容选项")
public class PageDataReq extends BaseListReq {
    ...
    @Schema(description = "类型(ENUM):1-商品;2-店铺分类;3-APP;4-快捷入口;5-资讯分类;6-资讯;8-自定义页面;10-社区版块;11-帖子;12-拼团;14-秒杀;17-代金券;")
