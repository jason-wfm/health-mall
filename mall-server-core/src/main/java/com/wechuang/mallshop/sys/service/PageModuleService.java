 ...
 * @since 2018-07-04
 */
public interface PageModuleService extends IBaseService<PageModule, PageModuleListReq> {
     ...
     * 页面模块表-分页列表查询
     *
     * @param pageModuleListReq
     * @return
     */
    IPage<PageModuleVo> getLists(PageModuleListReq pageModuleListReq);

    List<Map> fixPcPageModuleData(List<PageModule> page_data);
