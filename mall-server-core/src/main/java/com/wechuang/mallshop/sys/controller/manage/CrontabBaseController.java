...
import com.wechuang.mallshop.sys.model.req.CrontabBaseAddReq;
import com.wechuang.mallshop.sys.model.req.CrontabBaseEditReq;
import com.wechuang.mallshop.sys.model.req.CrontabBaseListReq;
import com.wechuang.mallshop.sys.model.req.CrontabBaseStateEditReq;
...
public class CrontabBaseController extends BaseController {
    ...
    @Operation(summary = "计划任务表-分页列表查询", description = "计划任务表-分页列表查询")
    ...
    @Operation(summary = "计划任务表-添加", description = "计划任务表-添加")
    ...
    @Operation(summary = "计划任务表-编辑", description = "计划任务表-编辑")
    ...
    @Operation(summary = "计划任务表-修改状态", description = "计划任务表-修改状态")
    ...
    @Operation(summary = "计划任务表-通过crontab_id删除", description = "计划任务表-通过crontab_id删除")
