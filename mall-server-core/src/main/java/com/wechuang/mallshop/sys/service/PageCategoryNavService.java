 ...
 * @since 2021-09-18
 */
public interface PageCategoryNavService extends IBaseService<PageCategoryNav, PageCategoryNavListReq> {
     ...
     * @return
     */
    Map getPcLayout(String sourceLang, Integer siteId);

    List<Map> getPcHelp(String sourceLang, Integer siteId);
}
