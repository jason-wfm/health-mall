...
import com.wechuang.mallshop.sys.model.req.DistrictBaseAddReq;
import com.wechuang.mallshop.sys.model.req.DistrictBaseEditReq;
...
public class DistrictBaseController extends BaseController {
    ...
    @Operation(summary = "地区表-列表查询", description = "地区表-列表查询")
    ...
    @Operation(summary = "地区表-分页列表查询", description = "地区表-分页列表查询")
    ...
    @Operation(summary = "地区表-添加", description = "地区表-添加")
    ...
    @Operation(summary = "地区表-编辑", description = "地区表-编辑")
    ...
    @Operation(summary = "地区表-通过district_id删除", description = "地区表-通过district_id删除")
    ...
    @Operation(summary = "地区表-批量删除", description = "地区表-批量删除")
