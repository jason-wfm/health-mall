 ...
 * @since 2021-07-03
 */
public interface PageBaseService extends IBaseService<PageBase, PageBaseListReq> {
     ...
     * @return
     */
    IPage<PageDataItemVo> getDataInfo(PageDataReq pageDataReq);
     ...
     * @return
     */
    PageBaseRes detail(Long pageId);

    Map getAllCenterMenu();

    Map getUserCenterMenu();
}
