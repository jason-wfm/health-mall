...
@TableName("sys_page_mobile_nav")
@Schema(name = "PageMobileNav对象", description = "移动端首页分类使用")
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
public class PageMobileNav implements Serializable {
    private static final long serialVersionUID = 1L;

    @Schema(description = "商品类别编号-一级分类使用")
