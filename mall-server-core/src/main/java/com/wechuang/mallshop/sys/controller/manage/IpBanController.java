...
import com.wechuang.mallshop.sys.model.entity.IpBan;
import com.wechuang.mallshop.sys.model.req.IpBanAddReq;
import com.wechuang.mallshop.sys.model.req.IpBanListReq;
import com.wechuang.mallshop.sys.service.IpBanService;
...
public class IpBanController extends BaseController {
    ...
    @Operation(summary = "IP禁止表-分页列表查询", description = "IP禁止表-分页列表查询")
    ...
    @Operation(summary = "IP禁止表-添加", description = "IP禁止表-添加")
    ...
    @Operation(summary = "IP禁止表-通过ban_ip删除", description = "IP禁止表-通过ban_ip删除")
