...
@Schema(name = "FeedbackBase对象", description = "平台反馈表")
...
public class FeedbackBase implements Serializable {
    ...
    @Schema(description = "反馈问题:在这里描述您遇到的问题")
    ...
    @Schema(description = "举报状态(BOOL):0-未处理;1-已处理")
    @TableField("feedback_question_status")
    private Boolean feedbackQuestionStatus;

    @Schema(description = "举报处理结果(ENUM):1-无效举报;2-恶意举报;3-有效举报")
