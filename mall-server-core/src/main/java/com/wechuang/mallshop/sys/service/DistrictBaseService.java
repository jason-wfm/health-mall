 ...
 * @since 2021-05-20
 */
public interface DistrictBaseService extends IBaseService<DistrictBase, DistrictBaseListReq> {
    /**
     * 地区树形
     *
     ...
     * @return
     */
    List<DistrictBaseRes> getTree(DistrictBaseListReq districtBaseListReq);
}
