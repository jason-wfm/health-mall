...
@TableName("sys_district_base")
@Schema(name = "DistrictBase对象", description = "地区表")
...
public class DistrictBase implements Serializable {
    ...
    @Schema(description = "地区等级")
    @TableField("district_level")
    private Integer districtLevel;

    @Schema(description = "区号")
    @TableField("district_citycode")
    private String districtCitycode;

    @Schema(description = "邮编")
    @TableField("district_zipcode")
    private String districtZipcode;

    @Schema(description = "经度")
    @TableField("district_lng")
    private BigDecimal districtLng;

    @Schema(description = "维度")
    @TableField("district_lat")
    private BigDecimal districtLat;

    @Schema(description = "地区排序")
    @TableField("district_sort")
