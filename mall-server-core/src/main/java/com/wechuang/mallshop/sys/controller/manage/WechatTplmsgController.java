...
import com.wechuang.mallshop.sys.model.entity.WechatTplmsg;
import com.wechuang.mallshop.sys.model.req.WechatTplmsgAddReq;
import com.wechuang.mallshop.sys.model.req.WechatTplmsgEditReq;
import com.wechuang.mallshop.sys.model.req.WechatTplmsgListReq;
import com.wechuang.mallshop.sys.service.WechatTplmsgService;
...
public class WechatTplmsgController extends BaseController {
    ...
    @Operation(summary = "消息模板表-通过tplmsg_id查询", description = "消息模板表-通过tplmsg_id查询")
    ...
    @Operation(summary = "消息模板表-通过tplmsg_id删除", description = "消息模板表-通过tplmsg_id删除")
