...
import com.wechuang.mallshop.sys.model.req.ExpressBaseAddReq;
import com.wechuang.mallshop.sys.model.req.ExpressBaseEditReq;
import com.wechuang.mallshop.sys.model.req.ExpressBaseListReq;
import com.wechuang.mallshop.sys.model.req.ExpressBaseStateEditReq;
...
public class ExpressBaseController extends BaseController {
    ...
    @Operation(summary = "快递表-分页列表查询", description = "快递表-分页列表查询")
    ...
    @Operation(summary = "快递表-查询快递公司列表", description = "快递表-查询快递公司列表")
    ...
    @Operation(summary = "快递表-添加", description = "快递表-添加")
    ...
    @Operation(summary = "快递表-编辑", description = "快递表-编辑")
    ...
    @Operation(summary = "快递表-通过express_id删除", description = "快递表-通过express_id删除")
    ...
    @Operation(summary = "快递表-通过express_id", description = "快递表-修改快递常用状态和启用状态")
