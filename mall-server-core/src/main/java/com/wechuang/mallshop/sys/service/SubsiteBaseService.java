 ...
 * @since 2025-01-06
 */
public interface SubsiteBaseService extends IBaseService<SubsiteBase, SubsiteBaseListReq> {

    /**
     * 城市分站表-分页列表查询
     *
     * @param subsiteBaseListReq
     * @return
     */
    IPage<SubsiteBaseRes> getList(SubsiteBaseListReq subsiteBaseListReq);
}
