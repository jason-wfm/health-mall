 ...
 * @since 2018-07-04
 */
public interface FeedbackBaseService extends IBaseService<FeedbackBase, FeedbackBaseListReq> {
     ...
     * @return
     */
    List<FeedbackTypeRes> getCategory();

    boolean editAnswer(FeedbackBase feedbackBase);
}
