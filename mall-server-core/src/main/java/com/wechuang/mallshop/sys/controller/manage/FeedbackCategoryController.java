...
import com.wechuang.mallshop.sys.model.req.FeedbackCategoryAddReq;
import com.wechuang.mallshop.sys.model.req.FeedbackCategoryEditReq;
import com.wechuang.mallshop.sys.model.req.FeedbackCategoryListReq;
import com.wechuang.mallshop.sys.model.req.FeedbackCategoryStateEditReq;
import com.wechuang.mallshop.sys.service.FeedbackCategoryService;
...
public class FeedbackCategoryController extends BaseController {
    ...
    @Operation(summary = "平台反馈主题分类表-分页列表查询", description = "平台反馈主题分类表-分页列表查询")
    ...
    @Operation(summary = "平台反馈主题分类表-添加", description = "平台反馈主题分类表-添加")
    ...
    @Operation(summary = "平台反馈主题分类表-编辑", description = "平台反馈主题分类表-编辑")
    ...
    @Operation(summary = "平台反馈主题分类表-修改状态", description = "平台反馈主题分类表-修改状态")
    ...
    @Operation(summary = "平台反馈主题分类表-通过feedback_category_id删除", description = "平台反馈主题分类表-通过feedback_category_id删除")
