...
@TableName("sys_express_base")
@Schema(name = "ExpressBase对象", description = "快递表")
...
public class ExpressBase implements Serializable {
    ...
    @TableField("express_pinyin")
    private String expressPinyin;

    @Schema(description = "快递公司100")
    @TableField("express_pinyin_100")
    private String expressPinyin100;

    @Schema(description = "快递官网")
    @TableField("express_site")
    private String expressSite;

    @Schema(description = "是否常用")
    @TableField("express_is_fav")
    private Boolean expressIsFav;

    @Schema(description = "快递排序:越小越靠前")
    @TableField("express_order")
    private Integer expressOrder;

    @Schema(description = "启用状态(BOOL):0-禁用;1-启用")
