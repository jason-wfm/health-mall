...
import com.wechuang.mallshop.sys.model.req.PageCategoryNavAddReq;
import com.wechuang.mallshop.sys.model.req.PageCategoryNavEditReq;
import com.wechuang.mallshop.sys.model.req.PageCategoryNavListReq;
import com.wechuang.mallshop.sys.model.req.PageCategoryNavStateEditReq;
...
public class PageCategoryNavController extends BaseController {
    ...
    @Operation(summary = "PC分类导航表-分页列表查询", description = "PC分类导航表-分页列表查询")
    ...
    @PreAuthorize("hasAuthority('/manage/sys/diy/index')")
    @Operation(summary = "PC分类导航表-添加", description = "PC分类导航表-添加")
    ...
    @PreAuthorize("hasAuthority('/manage/sys/diy/index')")
    @Operation(summary = "PC分类导航表-编辑", description = "PC分类导航表-编辑")
    ...
    @PreAuthorize("hasAuthority('/manage/sys/diy/index')")
    @Operation(summary = "PC分类导航表-通过category_nav_id删除", description = "PC分类导航表-通过category_nav_id删除")
