...
import com.wechuang.mallshop.cms.service.ArticleTagService;
import com.wechuang.mallshop.common.consts.ConstantCms;
...
public class ArticleBaseServiceImpl extends BaseServiceImpl<ArticleBaseRepository, ArticleBase, ArticleBaseListReq> implements ArticleBaseService {
    ...
    public IPage<ArticleBaseRes> getArticleBaseList(ArticleBaseListReq articleBaseListReq) {
        ...
        queryWrapper.orderByDesc("article_is_popular");
        ...
        if (articleBaseIPage != null && CollectionUtil.isNotEmpty(articleBaseIPage.getRecords())) {
            ...
            for (ArticleBase articleBase : articleList) {
                ...
                if (StrUtil.isNotEmpty(articleBase.getArticleTags())) {
                    List<String> arrayToList = Convert.toList(String.class, articleBase.getArticleTags());
                    articleBaseRes.setArticleTagList(articleTagService.gets(arrayToList));
                }
