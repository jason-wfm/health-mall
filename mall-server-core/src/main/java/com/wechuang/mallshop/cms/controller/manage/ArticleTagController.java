...
import com.wechuang.mallshop.cms.model.req.ArticleTagAddReq;
import com.wechuang.mallshop.cms.model.req.ArticleTagEditReq;
import com.wechuang.mallshop.cms.model.req.ArticleTagListReq;
...
public class ArticleTagController extends BaseController {
    ...
    @Operation(summary = "文章标签表-分页列表查询", description = "文章标签表-分页列表查询")
    ...
    @Operation(summary = "文章标签表-添加", description = "文章标签表-添加")
    ...
    @Operation(summary = "文章标签表-编辑", description = "文章标签表-编辑")
    ...
    @Operation(summary = "文章标签表-通过tag_id删除", description = "文章标签表-通过tag_id删除")
    ...
    @Operation(summary = "文章标签表-批量删除", description = "文章标签表-批量删除")
