...
@Schema(description = "出入库单据item表参数")
public class StockBillItemAddReq implements Serializable {

    private static final long serialVersionUID = 1L;

    @Schema(description = "源单号码")
    ...
    @Schema(description = "业务类别(ENUM):2750-入库;2700-出库")
