...
// +----------------------------------------------------------------------
package com.wechuang.mallshop.invoicing.repository;
 ...
 * @since 2018-07-04
 */
public interface StockBillRepository extends IBaseRepository<StockBill> {

    List<StockBillVo> findDetail(QueryWrapper<StockBill> queryWrapper);
}
