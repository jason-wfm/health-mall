 ...
 */
@Service
public class StockBillItemServiceImpl extends BaseServiceImpl<StockBillItemRepository, StockBillItem, StockBillItemListReq> implements StockBillItemService {
}
