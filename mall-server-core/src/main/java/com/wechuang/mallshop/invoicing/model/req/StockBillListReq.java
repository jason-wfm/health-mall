...
// +----------------------------------------------------------------------
package com.wechuang.mallshop.invoicing.model.req;
...
@Schema(description = "商品出入库单据表分页查询")
public class StockBillListReq extends BaseListReq {

    private static final long serialVersionUID = 1L;

    @Schema(description = "购货(退货)单编号")
    private String stockBillId;

    @Schema(description = "是否审核(BOOL):1-已审核;  0-未审核")
    ...
    @Schema(description = "业务类别purchase_type_id, sale_type_id(ENUM):2750-入库;2700-出库;2855-采购订单;2850-销售订单")
    private Integer billTypeId;

    @Schema(description = "库存类型(ENUM)")
    ...
    @Schema(description = "源单号码:一个订单一个出入库记录可以拆单")
