...
public class ControllerLogAspect {
    ...
    @Pointcut("@within(org.springframework.web.bind.annotation.RestController) " +
            "&& !@annotation(com.wechuang.mallshop.common.weblog.IgnoreLog)" +
            "&& !@within(com.wechuang.mallshop.common.weblog.IgnoreLog)")
    public void webLog() {
    ...
    public void throwing(JoinPoint joinPoint, Throwable e) {
        ...
        if (e != null) {
            ...
            if (CollUtil.isNotEmpty(exList)) {
                if (exList.get(0).equals("com.wechuang.mallshop.common.exception.BusinessException")) {
                    flag = false;
                }
            }
        }
