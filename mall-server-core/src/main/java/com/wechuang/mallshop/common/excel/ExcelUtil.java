package com.wechuang.mallshop.common.excel;

import cn.hutool.core.convert.Convert;
import cn.hutool.core.date.DateUtil;
import cn.hutool.core.util.ObjectUtil;
import com.wechuang.mallshop.common.utils.CSVUtils;
...
public class ExcelUtil {
    ...
    public static String[] dealHeadData(Field[] fields) {
        ...
        for (int i = 0; i < fields.length; i++) {
            ...
            String value = schema != null ? schema.description() : fields[i].getName();
            heads[i] = __(value);
        }
        return heads;
    }
            ...
            try {
                ...
                for (int i = 0; i < fields.length; i++) {
                    ...
                    if (fieldType.equals("java.lang.Boolean") && ObjectUtil.isNotEmpty(valueObj)) {
                        Schema schema = fields[i].getAnnotation(Schema.class);
                        String valueStr = schema != null ? schema.description() : "";
