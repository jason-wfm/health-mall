...
public class AudioUtil {
    ...
    public static Float getDuration(String filePath) {
        try {
            ...
            logger.error(String.format(__("获取语音文件播放时长失败,文件地址【%s】"), filePath));
            return 0f;
        }
    ...
    public static Float getMp3Duration(String filePath) {
        ...
        try {
            ...
            logger.error(String.format(__("获取mp3语音文件播放时长失败,文件地址【%s】"), filePath));
            return 0f;
        }
    }
    ...
    public static Float getMp3Duration(File mp3File) {
        ...
        try {
            ...
            logger.error("获取mp3语音文件播放时长失败！bean{}", mp3File);
            return 0f;
        }
    }
