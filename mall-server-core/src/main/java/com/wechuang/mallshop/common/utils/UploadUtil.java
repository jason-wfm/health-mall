...
public class UploadUtil {
     ...
     * @return File
     */
    public static File uploadVideo(MultipartFile file, String directory, boolean uuidName)
            throws IOException, IllegalStateException {
        File outFile = upload(file, directory, uuidName);
        return outFile;
    }
     ...
     * @return File
     */
    public static File uploadFile(MultipartFile file, String directory, boolean uuidName)
            throws IOException, IllegalStateException {
        File outFile = upload(file, directory, uuidName);
        return outFile;
    }
     ...
     * @return File
     */
    public static File uploadImg(MultipartFile file, String directory, boolean uuidName)
            throws IOException, IllegalStateException {
        File outFile = upload(file, directory, uuidName);
        return outFile;
    }
    ...
    public static void preview(File file, boolean forceDownload, String fileName, String pdfDir, String officeHome,
        ...
        if (forceDownload) {
            ...
            if (OpenOfficeUtil.canConverter(file.getName())) {
                File pdfFile = OpenOfficeUtil.converterToPDF(file.getAbsolutePath(), pdfDir);
                if (pdfFile != null) {
                    file = pdfFile;
                }
            }
    ...
    public static String getUploadBaseDir() {
        ...
        if (ConstantUpload.DIR.equals("")) {
            File[] files = File.listRoots();
            upDir = files[ConstantUpload.DIR_INDEX].getAbsolutePath()
                    .replace(File.separator, "/") + "upload";
        } else {
            upDir = ConstantUpload.DIR + "/upload";
        }
    ...
    public static String getUploadTempDir() {
        return getUploadBaseDir() + "/temp";
    }

    /**
     * 缩略图生成位置
     */
    public static String getUploadSmDir() {
     ...
     * office转pdf输出位置
     */
    public static String getPdfOutDir() {
