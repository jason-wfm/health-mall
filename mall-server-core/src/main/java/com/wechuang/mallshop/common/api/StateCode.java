...
public class StateCode {
    ...
    public static final int DISTRIBUTION_MODE_ALL = 1; //全民分销
    public static final int DISTRIBUTION_MODE_SPECIFY = 2; //指定分销

    public static final int DISTRIBUTION_BIND_ALL = 1; //分销绑定-所有用户
    public static final int DISTRIBUTION_BIND_NEW = 2; //分销绑定-新用户

    public static final int DISTRIBUTION_BIND_MODE_FOREVER = 1; //分销绑定永久
    public static final int DISTRIBUTION_BIND_MODE_PERIOD = 2; //分销绑定有效期
    public static final int DISTRIBUTION_BIND_MODE_TEMPORARY = 3; //分销绑定临时

    public static final int USER_STATE_LOCKING = 0; //用户状态:锁定
    public static final int USER_STATE_ACTIVATION = 1; //用户状态:已激活
    public static final int USER_STATE_NOTACTIVE = 2; //用户状态:未激活
    ...
    public static final int SUPPLY_TASK_MATCH = 1000; //匹配中
    public static final int SUPPLY_TASK_FINISH = 1010; //已完成
    public static final int SUPPLY_TASK_CANAL = 1020; //已取消
    public static final int SUPPLY_TASK_REJECTED = 1030; //被驳回
    public static final int SUPPLY_TASK_UNDERREVIEW = 1040; //审核中


    public static final int ACTIVITY_TYPE_BARGAIN = 1101; //加价购
    public static final int ACTIVITY_TYPE_GIFT = 1102; //店铺满赠-小礼品
    public static final int ACTIVITY_TYPE_LIMITED_DISCOUNT = 1103; //限时折扣
    public static final int ACTIVITY_TYPE_DISCOUNT_PACKAGE = 1104; //优惠套装
    public static final int ACTIVITY_TYPE_VOUCHER = 1105; //店铺优惠券  coupon 优惠券
    public static final int ACTIVITY_TYPE_DIY_PACKAGE = 1106; //砸金蛋
    public static final int ACTIVITY_TYPE_REDUCTION = 1107; //满减
    public static final int ACTIVITY_TYPE_MANHUI = 1108; //满返

    public static final int ACTIVITY_TYPE_POINT_SHOPPING = 1109; //积分换购

    public static final int ACTIVITY_TYPE_GIFTBAG = 1132; //A+B组合套餐
    public static final int ACTIVITY_TYPE_GIFTPACK = 1130; //礼包活动
    public static final int ACTIVITY_TYPE_MARKETING = 1131; //市场活动
    public static final int ACTIVITY_TYPE_LOTTERY = 1121; //幸运大抽奖
    public static final int ACTIVITY_TYPE_FLASHSALE = 1122; //秒杀
    public static final int ACTIVITY_TYPE_GROUPBOOKING = 1123; //拼团
    public static final int ACTIVITY_TYPE_CUTPRICE = 1124; //砍价
    public static final int ACTIVITY_TYPE_YIYUAN = 1125; //一元购
    public static final int ACTIVITY_TYPE_GROUPBUY_STORE = 1126; //团购
    public static final int ACTIVITY_TYPE_PF_GROUPBUY_STORE = 1127; //批发团购

    public static final int ACTIVITY_TYPE_MULTIPLEDISCOUNT = 1133; //多件折
    public static final int ACTIVITY_TYPE_BATDISCOUNT = 1135; //阶梯价
    public static final int ACTIVITY_TYPE_DOUBLE_POINTS = 1136; //多倍积分
    public static final int ACTIVITY_TYPE_POP = 1137; //弹窗活动
    public static final int ACTIVITY_TYPE_REDUCTION_AGAIN = 1140; //折上折
    ...
    public static final int ACTIVITY_GROUPBOOKING_FAIL = 0; //拼团状态:0-失败
    public static final int ACTIVITY_GROUPBOOKING_SUCCESS = 1; //拼团状态:1-成功
    public static final int ACTIVITY_GROUPBOOKING_UNDERWAY = 2; //拼团状态:2-进行中
    public static final int ACTIVITY_GROUPBOOKING_INEFFECTIVE = 3; //拼团状态:3-未生效, 待团长付款
    ...
    */
    ...
    public static final int STORE_STATE_OPENED = 3250; //已缴费开通,入驻完成(运营开关由store_is_open控制)

    public static final int SETTLEMENT_STATE_WAIT_CONFIRM = 0; //结算单待商家确认
    public static final int SETTLEMENT_STATE_CONFIRMED = 1; //已确认待出金
    public static final int SETTLEMENT_STATE_PAYING = 2; //出金中
    public static final int SETTLEMENT_STATE_FINISHED = 3; //已完成
    public static final int SETTLEMENT_STATE_REJECTED = 4; //已驳回(订单回滚为未结算)
    ...
    public static final int TRADE_TYPE_RETURN_GROUPBOOKING = 1219;//拼团失败退款
    ...
    public static final int TRADE_TYPE_BUY_PLUS = 1507; // PLUS会员卡购买
    ...
    public static final int PAYMENT_TYPE_BANK = 1306;//银行打款
    ...
    public static final int PAYMENT_CHANNEL_PAYPAL = 1434; //Paypal
    public static final int PAYMENT_CHANNEL_UNION = 1435; // 云闪付

    public static final int PAYMENT_CHANNEL_CREDIT = 1444; // 信用支付
    public static final int PAYMENT_CHANNEL_BANK = 1443; // 银行打款
    ...
    // 优惠券来源
    public static final String VOUCHER_SOURCE_DEFAULT = "normal"; // 默认
    public static final String VOUCHER_SOURCE_MANUAL = "manual"; // 手动领取
    public static final String VOUCHER_SOURCE_PLUS_OPEN = "open"; // 开通PLUS发放
    public static final String VOUCHER_SOURCE_PLUS_MONTHLY = "monthly"; // PLUS每月领取
    public static final String VOUCHER_SOURCE_ADMIN = "admin"; // 后台管理员发放
    public static final String VOUCHER_SOURCE_FULL_RETURN = "full_return"; // 满返券

    // 定义价格类型
    public static final String PRICE_TYPE_NORMAL = "normal"; // 默认-普通销售价（无优惠）
    public static final String PRICE_TYPE_LEVEL = "level"; // 会员价（等级价）
    public static final String PRICE_TYPE_PLUS = "plus"; // PLUS价
    public static final String PRICE_TYPE_ACTIVITY = "activity"; // 活动价
    public static final String PRICE_TYPE_POLICY = "policy"; // 一客一价（专属价）
