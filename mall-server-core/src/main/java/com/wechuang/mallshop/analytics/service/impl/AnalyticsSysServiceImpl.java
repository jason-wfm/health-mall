...
import com.wechuang.mallshop.analytics.dao.AnalyticsSysDao;
...
import com.wechuang.mallshop.analytics.service.AnalyticsSysService;
...
public class AnalyticsSysServiceImpl implements AnalyticsSysService {
    ...
    public AnalyticsNumOutput getAccessItemNum(AccessItemTimelineInput input) {
        ...
        // 获取当前周期内数据
        CommonNumVo currentProductNum = analyticsSysDao.getAccessItemNum(input.getStime(), input.getEtime(), input.getItemId(), storeId);
        if (currentProductNum != null) {
            topRes.setCurrent(currentProductNum.getNum());
        }
        ...
        if (CheckUtil.isNotEmpty(input.getStime()) && CheckUtil.isNotEmpty(input.getEtime())) {
            ...
            CommonNumVo preProductNum = analyticsSysDao.getAccessItemNum(preInput.getStime(), preInput.getEtime(), preInput.getItemId(), storeId);
    ...
    public AnalyticsNumOutput getAccessItemUserNum(AccessItemTimelineInput input) {
        ...
        // 获取当前周期内数据
        CommonNumVo currentProductNum = analyticsSysDao.getAccessItemUserNum(input.getStime(), input.getEtime(), input.getItemId(), storeId);
        if (currentProductNum != null) {
            topRes.setCurrent(currentProductNum.getNum());
        }
        ...
        if (CheckUtil.isNotEmpty(input.getStime()) && CheckUtil.isNotEmpty(input.getEtime())) {
            ...
            CommonNumVo preProductNum = analyticsSysDao.getAccessItemUserNum(input.getStime(), input.getEtime(), input.getItemId(), storeId);
