...
@Schema(name = "OrderInfo对象", description = "订单信息表")
...
public class OrderInfo implements Serializable {
    ...
    @Schema(description = "订单是否结算(BOOL):0-未结算; 1-已结算; 2-待结算")
    ...
    @Schema(description = "订单审核(ENUM):0-未审核;1-审核通过;2-审核驳回;")
    ...
    @TableField("order_return_hidden")
    private Boolean orderReturnHidden;

    @Schema(description = "推送微信发货是否成功(ENUM):0未推送;1-推送成功;2-推送失败")
    @TableField("order_push_wx_shipping")
    private Integer orderPushWxShipping;

    @Schema(description = "开票按钮隐藏(BOOL): 1-是; 0-否")
    @TableField("order_invoice_hidden")
