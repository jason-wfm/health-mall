...
@TableName("trade_order_comment")
@Schema(name = "OrderComment对象", description = "订单店铺评价表")
...
public class OrderComment implements Serializable {
    ...
    @Schema(description = "描述相符评分 - order_buyer_evaluation_status , 评价状态改变后不需要再次评论，根据订单走")
    @TableField("comment_store_desc_credit")
    private Integer commentStoreDescCredit;

    @Schema(description = "服务态度评分 - order_buyer_evaluation_status")
    @TableField("comment_store_service_credit")
    private Integer commentStoreServiceCredit;

    @Schema(description = "发货速度评分 - order_buyer_evaluation_status")
    @TableField("comment_store_delivery_credit")
    private Integer commentStoreDeliveryCredit;
