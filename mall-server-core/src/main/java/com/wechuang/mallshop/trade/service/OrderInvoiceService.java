 ...
 * @since 2021-05-09
 */
public interface OrderInvoiceService extends IBaseService<OrderInvoice, OrderInvoiceListReq> {

    /**
     * 订单发票管理表-分页列表查询
     * @param orderInvoiceListReq
     * @return
     */
    IPage<OrderInvoiceRes> getList(OrderInvoiceListReq orderInvoiceListReq);
}
