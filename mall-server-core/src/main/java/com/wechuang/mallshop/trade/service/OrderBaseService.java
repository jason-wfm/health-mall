 ...
 * @since 2021-07-03
 */
public interface OrderBaseService extends IBaseService<OrderBase, OrderBaseListReq> {
     ...
     * @return
     */
    OrderCommentRes getEvaluationItem(EvaluationVo evaluationVo);
    ...
    boolean handleCanStudy(Long productId, String orderId);
