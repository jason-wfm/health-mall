...
// +----------------------------------------------------------------------
package com.wechuang.mallshop.trade.service;
...
public interface OrderService {
     ...
     * @return
     */
    boolean companyOrderReview(OrderReviewReq orderReviewReq);
     ...
     * @return
     */
    boolean verification(String orderId);
     ...
     * @param response
     */
    void batchOrderTemp(HttpServletResponse response);
     ...
     * @throws Exception
     */
    void importBatchOrderTemp(MultipartFile file) throws Exception;
     ...
     * @return
     */
    OrderSettlementRes getSettlementList(OrderInfoListReq orderInfoListReq);
     ...
     * @return
     */
    boolean settlementApply(Integer user_bank_id);
     ...
     * @return
     */
    OrderPayRes getPayList(List<String> orderIds);
     ...
     * @return
     */
    boolean doUploadShipping(String orderId);
     ...
     * @return
     */
    BatchOrderDataRes batchOrders(BatchOrderListReq batchOrderListReq);
     ...
     * @return
     */
    boolean editBatchOrder(BatchOrder batchOrder);
     ...
     * @return
     */
    boolean addBatchOrder(Long itemId);
     ...
     * @return
     */
    boolean removeBatchOrders(List<Integer> batchIds);
     ...
     * @return
     */
    boolean reviseOrderInvoice(Integer orderInvoiceId, Integer userInvoiceId);
     ...
     * @return
     */
    OrderAddOutput addCustomerOrder(CheckoutInput orderBase);
     ...
     * @return
     */
    IPage<OrderCourseRes> purchasedCourseList(OrderInfoListReq orderInfoListReq);
     ...
     * @return
     */
    boolean orderAdjustFee(List<OrderItem> orderItems);

    /**
     * 分销确认收货结算
     */
    void autoDistributionOrder();

    /**
     * 统计信息
     * @return
     */
    SellerDashboardRes sellerDashboard();
