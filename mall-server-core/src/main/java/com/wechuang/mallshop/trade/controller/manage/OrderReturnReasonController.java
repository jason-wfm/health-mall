...
import com.wechuang.mallshop.trade.model.req.OrderReturnReasonAddReq;
import com.wechuang.mallshop.trade.model.req.OrderReturnReasonEditReq;
import com.wechuang.mallshop.trade.model.req.OrderReturnReasonListReq;
import com.wechuang.mallshop.trade.service.OrderReturnReasonService;
...
public class OrderReturnReasonController extends BaseController {
    ...
    @Operation(summary = "退货原因表-分页列表查询", description = "退货原因表-分页列表查询")
    ...
    @Operation(summary = "退货原因表-添加", description = "退货原因表-添加")
    ...
    @Operation(summary = "退货原因表-编辑", description = "退货原因表-编辑")
    ...
    @Operation(summary = "退货原因表-通过return_reason_id删除", description = "退货原因表-通过return_reason_id删除")
