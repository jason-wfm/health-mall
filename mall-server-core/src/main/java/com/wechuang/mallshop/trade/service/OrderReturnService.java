...
import com.wechuang.mallshop.trade.model.entity.OrderReturnItem;
...
public interface OrderReturnService extends IBaseService<OrderReturn, OrderReturnListReq> {
     ...
     *
     * @param returnId
     * @param return_purchase_remark
     * @return
     */
    boolean cancel(String returnId, String return_purchase_remark);
     ...
     * @return
     */
    boolean saveOrderReturn(String returnId, Integer orderIsSettlemented);
     ...
     * @return
     */
    String addWhole(OrderReturnInput orderReturnInput);
     ...
     * @return
     */
    OrderReturnVo returnWhole(String orderId, Integer userId);

    /**
     * 获取支付宝/微信/Paypal 退款订单
     * @return
     */
    List<String> getOnlineRefundReturnIds();

    Long getReturnNum(List<Integer> returnStateIds, Integer storeId);
}
