...
@Schema(name = "OrderInvoice对象", description = "订单发票管理表")
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
public class OrderInvoice implements Serializable {
    private static final long serialVersionUID = 1L;

    @Schema(description = "发票编号")
    @TableId(value = "order_invoice_id", type = IdType.AUTO)
    ...
    @Schema(description = "是否支付(BOOL): 0-未支付; 1-已支付;")
    @TableField("order_is_paid")
    private Boolean orderIsPaid;

    @Schema(description = "开票状态(ENUM): 0-未开票; 1-已开票; 2-已拒绝")
    @TableField("invoice_status")
    private Integer invoiceStatus;

    @Schema(description = "开票状态备注")
    @TableField("invoice_status_remark")
    private String invoiceStatusRemark;
