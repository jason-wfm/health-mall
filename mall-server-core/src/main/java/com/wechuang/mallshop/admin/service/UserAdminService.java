...
// +----------------------------------------------------------------------
package com.wechuang.mallshop.admin.service;
...
public interface UserAdminService extends IBaseService<UserAdmin, UserAdminListReq> {
    ...
    // 根据店铺ID查询 管理员用户ID
    Integer getUserIdByStoreId(Integer storeId);

    /**
     * 管理员表-分页列表查询
     *
     * @param userAdminListReq
     * @return
     */
    IPage<UserAdminRes> getList(UserAdminListReq userAdminListReq);

    Integer getSellerUserId(Integer storeId);

    Integer getNoticeUserId(Integer storeId);
}
