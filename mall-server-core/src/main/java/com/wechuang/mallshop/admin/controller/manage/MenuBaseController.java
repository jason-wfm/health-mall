...
import com.wechuang.mallshop.admin.model.req.MenuBaseAddReq;
import com.wechuang.mallshop.admin.model.req.MenuBaseEditReq;
import com.wechuang.mallshop.admin.model.req.MenuBaseStateEditReq;
import com.wechuang.mallshop.admin.model.req.MenuTreeReq;
import com.wechuang.mallshop.admin.model.res.MenuTreeRes;
import com.wechuang.mallshop.admin.repository.UserAdminRepository;
import com.wechuang.mallshop.admin.service.MenuBaseService;
...
public class MenuBaseController extends BaseController {
    ...
    @Operation(summary = "系统菜单表-分页列表查询", description = "系统菜单表-分页列表查询")
    ...
    @Operation(summary = "系统菜单表-添加", description = "系统菜单表-添加")
    ...
    @Operation(summary = "系统菜单表-编辑", description = "系统菜单表-编辑")
    ...
    @Operation(summary = "系统菜单表-通过menu_id删除", description = "系统菜单表-通过menu_id删除")
    ...
    @Operation(summary = "系统菜单表-状态修改", description = "系统菜单表-状态修改")
