 ...
 * @since 2022-12-22
 */
public interface UserRoleService extends IBaseService<UserRole, UserRoleListReq> {

    /**
     * 权限组表-分页列表查询
     *
     * @param userRoleListReq
     * @return
     */
    IPage<UserRole> getList(UserRoleListReq userRoleListReq);
