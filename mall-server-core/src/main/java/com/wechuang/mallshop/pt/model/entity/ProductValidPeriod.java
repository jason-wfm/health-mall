...
@TableName("pt_product_valid_period")
@Schema(name = "ProductValidPeriod对象", description = "虚拟商品信息表")
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
public class ProductValidPeriod implements Serializable {
