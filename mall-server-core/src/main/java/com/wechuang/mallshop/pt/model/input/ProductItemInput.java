...
public class ProductItemInput extends BaseListReq {
    ...
    @QueryField(value = "product_name_index", type = QueryType.LIKE)
    ...
    @Schema(description = "是否为默认展示的商品-列表页展示，必须为item_enable")
