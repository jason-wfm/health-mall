...
import com.wechuang.mallshop.pt.model.entity.ProductTag;
import com.wechuang.mallshop.pt.model.req.ProductTagAddReq;
import com.wechuang.mallshop.pt.model.req.ProductTagEditReq;
import com.wechuang.mallshop.pt.model.req.ProductTagListReq;
import com.wechuang.mallshop.pt.service.ProductTagService;
...
public class ProductTagController extends BaseController {
    ...
    @Operation(summary = "商品标签表-分页列表查询", description = "商品标签表-分页列表查询")
    ...
    @Operation(summary = "商品标签表-通过product_tag_id查询", description = "商品标签表-通过product_tag_id查询")
    ...
    public CommonRes<ProductTag> get(@PathVariable Integer productTagId) {
        ...
        ProductTag tag = productTagService.get(productTagId);
    ...
    @Operation(summary = "商品标签表-添加", description = "商品标签表-添加")
    ...
    @Operation(summary = "商品标签表-编辑", description = "商品标签表-编辑")
    ...
    public CommonRes<?> edit(ProductTagEditReq productTagEditReq) {
        ...
        ProductTag tag = productTagService.get(productTagEditReq.getProductTagId());
    ...
    @Operation(summary = "商品标签表-通过product_tag_id删除", description = "商品标签表-通过product_tag_id删除")
