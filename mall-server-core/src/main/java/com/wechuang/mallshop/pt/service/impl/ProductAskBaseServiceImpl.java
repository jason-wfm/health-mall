 ...
 */
@Service
public class ProductAskBaseServiceImpl extends BaseServiceImpl<ProductAskBaseRepository, ProductAskBase, ProductAskBaseListReq> implements ProductAskBaseService {
}
