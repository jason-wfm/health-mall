...
// +----------------------------------------------------------------------
package com.wechuang.mallshop.pt.repository;
...
public interface ProductItemRepository extends IBaseRepository<ProductItem> {
    ...
    static boolean ifOnSale(ProductItemVo item) {
        ...
        return Objects.equals(item.getProductStateId(), StateCode.PRODUCT_STATE_NORMAL) && Objects.equals(item.getItemEnable(), StateCode.PRODUCT_STATE_NORMAL) && availableQuantity > 0 && item.getItemQuantity() > 0;
    }
}
