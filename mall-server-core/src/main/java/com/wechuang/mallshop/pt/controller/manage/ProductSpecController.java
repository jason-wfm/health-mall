...
import com.wechuang.mallshop.pt.model.req.ProductSpecAddReq;
import com.wechuang.mallshop.pt.model.req.ProductSpecEditReq;
...
public class ProductSpecController extends BaseController {
    ...
    @Operation(summary = "商品规格表-分页列表查询", description = "商品规格表-分页列表查询")
    ...
    @Operation(summary = "商品规格表-递归查询", description = "商品规格表-递归查询")
    ...
    @Operation(summary = "商品规格表-添加", description = "商品规格表-添加")
    ...
    @Operation(summary = "商品规格表-编辑", description = "商品规格表-编辑")
    ...
    @Operation(summary = "商品规格表-通过spec_id删除", description = "商品规格表-通过spec_id删除")
