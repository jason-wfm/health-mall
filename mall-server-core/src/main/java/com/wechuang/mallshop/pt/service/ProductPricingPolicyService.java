 ...
 * @since 2025-02-19
 */
public interface ProductPricingPolicyService extends IBaseService<ProductPricingPolicy, ProductPricingPolicyListReq> {

    IPage<ProductPricingPolicyOutput> listItem(ProductPricingPolicyListReq productPricingPolicyListReq);
