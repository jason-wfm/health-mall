...
public interface ProductIndexService extends IBaseService<ProductIndex, ProductIndexListReq> {
     ...
     * @return
     */
    boolean editVerify(ProductIndex productIndex);

    ProductListRes listProduct(ProductIndexInput productIndexListReq);

    ProductItemVo skuItem(Long itemId, Integer userId);
}
