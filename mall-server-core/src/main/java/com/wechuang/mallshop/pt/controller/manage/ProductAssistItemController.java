...
import com.wechuang.mallshop.pt.model.req.ProductAssistItemAddReq;
import com.wechuang.mallshop.pt.model.req.ProductAssistItemEditReq;
...
public class ProductAssistItemController extends BaseController {
    ...
    @Operation(summary = "商品辅助属性值表-分页列表查询", description = "商品辅助属性值表-分页列表查询")
    ...
    @Operation(summary = "商品辅助属性值表-添加", description = "商品辅助属性值表-添加")
    ...
    @Operation(summary = "商品辅助属性值表-编辑", description = "商品辅助属性值表-编辑")
    ...
    @Operation(summary = "商品辅助属性值表-通过assist_item_id删除", description = "商品辅助属性值表-通过assist_item_id删除")
    ...
    @Operation(summary = "商品辅助属性值表-批量删除", description = "商品辅助属性值表-批量删除")
