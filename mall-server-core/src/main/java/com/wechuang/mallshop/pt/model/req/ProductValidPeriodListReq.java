...
@Schema(description = "虚拟商品信息表分页查询")
public class ProductValidPeriodListReq extends BaseListReq {
    ...
    private Date productValidityStart;

    @Schema(description = "失效时间")
    private Date productValidityEnd;
    ...
    @Schema(description = "预约服务日期")
    private Date productServiceDate;
