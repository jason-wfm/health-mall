...
@Schema(description = "价格策略表-按客户定价分页查询")
public class ProductPricingPolicyListReq extends BaseListReq {
    ...
    private String sidx = "policy_id";

    @Schema(description = "商品名称")
    private String productName;

    public ProductPricingPolicyListReq() {
        setSidx("policy_id");
