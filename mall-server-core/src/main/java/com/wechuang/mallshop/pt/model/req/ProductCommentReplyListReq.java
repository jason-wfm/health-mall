...
@Schema(description = "商品评价回复表分页查询")
public class ProductCommentReplyListReq extends BaseListReq {

    private static final long serialVersionUID = 1L;

    @Schema(description = "评论回复编号")
    ...
    @Schema(description = "评论回复时间")
    private Date commentReplyTime;

    @Schema(description = "允许显示")
    private Boolean commentReplyEnable;

    @Schema(description = "管理员评价")
