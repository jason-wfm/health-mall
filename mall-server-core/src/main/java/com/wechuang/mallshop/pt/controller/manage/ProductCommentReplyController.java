...
import com.wechuang.mallshop.pt.model.req.ProductCommentReplyReq;
import com.wechuang.mallshop.pt.model.req.ProductCommentReplyStateEditReq;
...
public class ProductCommentReplyController extends BaseController {
    ...
    @Operation(summary = "商品评价回复表-分页列表查询", description = "商品评价回复表-分页列表查询")
    ...
    @PreAuthorize("hasAuthority('/manage/pt/productComment/list')")
    @Operation(summary = "商品评价回复表-添加", description = "商品评价回复表-添加")
    ...
    @PreAuthorize("hasAuthority('/manage/pt/productComment/list')")
    @Operation(summary = "商品评价回复表-通过comment_reply_id删除", description = "商品评价回复表-通过comment_reply_id删除")
