...
@TableName("pt_product_association")
@Schema(name = "ProductAssociation对象", description = "关联商品表")
...
public class ProductAssociation implements Serializable {
    ...
    @Schema(description = "上级商品id")
    @TableField("product_parent_id")
