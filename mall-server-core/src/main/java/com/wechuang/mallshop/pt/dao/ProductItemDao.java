...
public interface ProductItemDao extends BaseMapper<ProductItem> {
    int lockSkuStock(@Param("item_id") Long itemId, @Param("cart_quantity") int cartQuantity);

    int releaseSkuStock(@Param("item_id") Long itemId, @Param("cart_quantity") int cartQuantity);
    ...
    int getStockWarningCount(@Param("store_id") Integer storeId, @Param("warning") Integer warning);
}
