...
@Schema(description = "商品咨询参数")
public class ProductAskBaseAddReq implements Serializable {

    private static final long serialVersionUID = 1L;

    @Schema(description = "咨询类别编号")
    ...
    @Schema(description = "是否回复(BOOL):0-未回复;1-已回复")
    private Boolean askStatus;

    @Schema(description = "是否现实(BOOL):0-不公开;1-公开")
