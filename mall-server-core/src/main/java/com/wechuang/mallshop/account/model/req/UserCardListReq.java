...
@Schema(description = "用户会员卡分页查询")
public class UserCardListReq extends BaseListReq {
    ...
    private String userLevelName;   //user_level_name 该字段不是数据库表中的字段
