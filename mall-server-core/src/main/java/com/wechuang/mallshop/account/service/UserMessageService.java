...
public interface UserMessageService extends IBaseService<UserMessage, UserMessageListReq> {
    ...
    ImConfigOutput getImConfig(Integer userId, Integer userOtherId, Long chatItemId, String chatOrderId);

    KefuConfigOutput getKefuConfig(Integer userId, Integer storeId, Integer friendId);
