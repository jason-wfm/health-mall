...
import com.wechuang.mallshop.account.model.req.UserDeliveryAddressAddReq;
import com.wechuang.mallshop.account.model.req.UserDeliveryAddressEditReq;
...
public class UserDeliveryAddressController extends BaseController {
    ...
    @Operation(summary = "用户地址表-分页列表查询", description = "用户地址表-分页列表查询")
    ...
    @Operation(summary = "用户地址表-添加", description = "用户地址表-添加")
    ...
    @Operation(summary = "用户地址表-编辑", description = "用户地址表-编辑")
    ...
    @Operation(summary = "用户地址表-通过ud_id删除", description = "用户地址表-通过ud_id删除")
    ...
    @Operation(summary = "用户地址表-批量删除", description = "用户地址表-批量删除")
