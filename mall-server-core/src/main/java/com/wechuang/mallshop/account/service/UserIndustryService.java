 ...
 * @since 2025-03-17
 */
public interface UserIndustryService extends IBaseService<UserIndustry, UserIndustryListReq> {

    /**
     * 获取行业树形结构
     *
     * @param userIndustryListReq
     * @return
     */
    List<UserIndustryRes> tree(UserIndustryListReq userIndustryListReq);

    /**
     * 用户行业表-通过industry_id删除
     *
     * @param industryId
     * @return
     */
    boolean removeById(Integer industryId);
}
