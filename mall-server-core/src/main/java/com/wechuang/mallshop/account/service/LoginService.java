...
import com.wechuang.mallshop.account.model.res.ExpRuleRes;
...
public interface LoginService extends UserDetailsService {
     ...
     * @return
     */
    boolean addSourceUserId(Integer userId, Integer userParentId, Integer activityId, Boolean isRegister);
     ...
     * @return
     */
    boolean checkSourceUserId(Integer user_id);
}
