...
import com.wechuang.mallshop.account.dao.UserSnsDao;
 ...
 */
@Repository
public class UserSnsRepositoryImpl extends BaseRepositoryImpl<UserSnsDao, UserSns> implements UserSnsRepository {
