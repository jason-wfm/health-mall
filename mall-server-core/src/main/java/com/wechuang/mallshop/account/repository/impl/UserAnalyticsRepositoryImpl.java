...
import com.wechuang.mallshop.account.dao.UserAnalyticsDao;
 ...
 */
@Repository
public class UserAnalyticsRepositoryImpl extends BaseRepositoryImpl<UserAnalyticsDao, UserAnalytics> implements UserAnalyticsRepository {
