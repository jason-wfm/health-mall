...
public class UserInvoiceController extends BaseController {
    ...
    @Operation(summary = "用户发票管理表-分页列表查询", description = "用户发票管理表-分页列表查询")
    ...
    @Operation(summary = "用户发票管理表-添加", description = "用户发票管理表-添加")
    ...
    @Operation(summary = "用户发票管理表-批量删除", description = "用户发票管理表-批量删除")
