...
@Schema(description = "用户行业表分页查询")
public class UserIndustryListReq extends BaseListReq {
    ...
    private Boolean industryEnable;

    @Schema(description = "租户编号")
    private Integer subsiteId;

    public UserIndustryListReq() {
        setSidx("industry_sort");
        setSort(Constants.ORDER_BY_ASC);
    }
