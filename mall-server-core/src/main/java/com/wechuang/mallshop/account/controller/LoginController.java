package com.wechuang.mallshop.account.controller;
...
import com.wechuang.mallshop.account.model.req.RegReq;
import com.wechuang.mallshop.account.model.req.ResetPasswordReq;
import com.wechuang.mallshop.account.model.res.LoginPolicyRes;
import com.wechuang.mallshop.account.model.res.LoginRes;
import com.wechuang.mallshop.account.model.res.LogoutRes;
...
public class LoginController extends BaseController {
    ...
    @Operation(summary = "短信登录接口", description = "短信登录接口")
    ...
    @Operation(summary = "重设密码接口", description = "重设密码接口")
    ...
    @Operation(summary = "隐私政策", description = "隐私政策")
