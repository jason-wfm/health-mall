...
import com.wechuang.mallshop.account.model.entity.UserTagGroup;
import com.wechuang.mallshop.account.model.req.UserTagGroupAddReq;
import com.wechuang.mallshop.account.model.req.UserTagGroupEditReq;
import com.wechuang.mallshop.account.model.req.UserTagGroupListReq;
import com.wechuang.mallshop.account.model.res.UserTagGroupRes;
import com.wechuang.mallshop.account.service.UserTagGroupService;
...
public class UserTagGroupController extends BaseController {
    ...
    @Operation(summary = "标签分组表-分页列表查询", description = "标签分组表-分页列表查询")
    ...
    @Operation(summary = "标签分组表-添加", description = "标签分组表-添加")
    ...
    @Operation(summary = "标签分组表-编辑", description = "标签分组表-编辑")
    ...
    @Operation(summary = "标签分组表-通过tag_group_id删除", description = "标签分组表-通过tag_group_id删除")
    ...
    @Operation(summary = "标签分组表-树形集合", description = "标签分组表-树形集合")
