...
import com.wechuang.mallshop.account.model.req.UserTagBaseAddReq;
import com.wechuang.mallshop.account.model.req.UserTagBaseEditReq;
import com.wechuang.mallshop.account.model.req.UserTagBaseListReq;
import com.wechuang.mallshop.account.model.req.UserTagBaseStateEditReq;
import com.wechuang.mallshop.account.service.UserTagBaseService;
...
public class UserTagBaseController extends BaseController {
    ...
    @Operation(summary = "用户标签表-分页列表查询", description = "用户标签表-分页列表查询")
    ...
    @Operation(summary = "用户标签表-添加", description = "用户标签表-添加")
    ...
    @Operation(summary = "用户标签表-编辑", description = "用户标签表-编辑")
    ...
    @Operation(summary = "用户标签表-状态", description = "用户标签表-状态")
    ...
    @Operation(summary = "用户标签表-通过tag_id删除", description = "用户标签表-通过tag_id删除")
