...
@TableName("account_user_tag_group")
@Schema(name = "UserTagGroup对象", description = "标签分组表")
...
public class UserTagGroup implements Serializable {
    ...
    @TableField("tag_group_sort")
    private Integer tagGroupSort;

    @Schema(description = "是否有效(BOOL):0-禁用;1-启用")
    @TableField("tag_group_enable")
    private Boolean tagGroupEnable;

    @Schema(description = "系统内置(BOOL):1-是; 0-否")
    @TableField("tag_group_buildin")
    private Boolean tagGroupBuildin;
