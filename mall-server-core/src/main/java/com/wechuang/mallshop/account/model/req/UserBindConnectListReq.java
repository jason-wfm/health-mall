...
@Schema(description = "用户绑定表分页查询")
public class UserBindConnectListReq extends BaseListReq {

    private static final long serialVersionUID = 1L;

    @Schema(description = "绑定标记")
    private String bindId;

    @Schema(description = "绑定类型(EMUN):1-mobile;  2-email;   13-weixin公众号")
    ...
    @Schema(description = "访问编号")
    private String bindOpenid;

    @Schema(description = "unionid")
    private String bindUnionid;

    @Schema(description = "是否激活(BOOL):0-未激活;1-激活")
    private Boolean bindActive;

    @TableField(exist = false)
    private String sidx = "bind_id";
