...
import com.wechuang.mallshop.pay.model.req.RechargeLevelAddReq;
import com.wechuang.mallshop.pay.model.req.RechargeLevelEditReq;
...
public class RechargeLevelController extends BaseController {
    ...
    @Operation(summary = "定额充值表-通过recharge_level_id查询", description = "定额充值表-通过recharge_level_id查询")
    ...
    @Operation(summary = "定额充值表-添加", description = "定额充值表-添加")
    ...
    @Operation(summary = "定额充值表-编辑", description = "定额充值表-编辑")
    ...
    @Operation(summary = "定额充值表-通过recharge_level_id删除", description = "定额充值表-通过recharge_level_id删除")
    ...
    @Operation(summary = "定额充值表-批量删除", description = "定额充值表-批量删除")
