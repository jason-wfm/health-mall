...
@Schema(name = "ConsumeWithdraw对象", description = "提现申请表")
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
public class ConsumeWithdraw implements Serializable {
    ...
    @Schema(description = "提现状态(ENUM):0-申请中;1-提现通过;2-驳回;3-打款完成;4-打款失败;5-商家付款确认;6-发票待审核;7-发票驳回")
    @TableField("withdraw_state")
    private Integer withdrawState;

    @Schema(description = "描述")
    @TableField("withdraw_desc")
    ...
    @TableField("withdraw_account_no")
    private String withdrawAccountNo;

    @Schema(description = "开户名称")
    @TableField("withdraw_account_name")
    ...
    @TableField("withdraw_trans_state")
