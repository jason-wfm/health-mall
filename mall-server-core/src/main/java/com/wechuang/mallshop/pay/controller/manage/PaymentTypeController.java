...
import com.wechuang.mallshop.pay.model.entity.PaymentType;
import com.wechuang.mallshop.pay.model.req.PaymentTypeAddReq;
import com.wechuang.mallshop.pay.model.req.PaymentTypeEditReq;
import com.wechuang.mallshop.pay.model.req.PaymentTypeListReq;
import com.wechuang.mallshop.pay.service.PaymentTypeService;
...
public class PaymentTypeController extends BaseController {
    ...
    @Operation(summary = "支付方式表-分页列表查询", description = "支付方式表-分页列表查询")
    ...
    @Operation(summary = "支付方式表-通过payment_type_id查询", description = "支付方式表-通过payment_type_id查询")
    ...
    @Operation(summary = "支付方式表-添加", description = "支付方式表-添加")
    ...
    @Operation(summary = "支付方式表-编辑", description = "支付方式表-编辑")
    ...
    @Operation(summary = "支付方式表-通过payment_type_id删除", description = "支付方式表-通过payment_type_id删除")
    ...
    @Operation(summary = "支付方式表-批量删除", description = "支付方式表-批量删除")
