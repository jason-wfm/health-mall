...
public interface UserResourceService extends IBaseService<UserResource, UserResourceListReq> {
     ...
     * @return
     */
    DistributionCommissionRes getCommissionInfo(Integer userId);
    ...
    boolean editResource(UserResource userResource);
    ...
    boolean checkUpdateUserLevel(Integer userId, Integer useExpTotal, BigDecimal userSpend);
}
