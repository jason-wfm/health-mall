...
import com.wechuang.mallshop.pay.dao.ConsumeRecordDao;
 ...
 */
@Repository
public class ConsumeRecordRepositoryImpl extends BaseRepositoryImpl<ConsumeRecordDao, ConsumeRecord> implements ConsumeRecordRepository {
