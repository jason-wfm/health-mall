...
@TableName("pay_payment_type")
@Schema(name = "PaymentType对象", description = "支付方式表")
...
public class PaymentType implements Serializable {
    ...
    @TableField("payment_type_order")
    private Integer paymentTypeOrder;

    @Schema(description = "备注")
    @TableField("payment_type_remark")
    private String paymentTypeRemark;

    @Schema(description = "是否启用(BOOL):0-禁用;1-启用")
    @TableField("payment_type_enable")
    private Boolean paymentTypeEnable;
