...
/**
 * <p>
 * 交易订单表-强调唯一订单-充值则先创建充值订单 服务类
 * </p>
 *
 * @author Xinze
 * @since 2021-06-30
 */
public interface ConsumeTradeService extends IBaseService<ConsumeTrade, ConsumeTradeListReq> {
    /**
     * 订单付款
     *
     * @param ids
     ...
     * @return
     */
    ProcessPayOutput processPay(String ids, PayMetVo info);
}
