...
/**
 * <p>
 * 支付表-支付回调callback使用-确认付款 服务类
 * </p>
 *
 * @author Xinze
 * @since 2021-06-30
 */
public interface ConsumeDepositService extends IBaseService<ConsumeDeposit, ConsumeDepositListReq> {
    Long offlinePay(ConsumeDeposit in);
     ...
     * @return
     */
    boolean bankPay(PaymentReq req);

    /**
     * @param consumeDeposit
     * @return
     */
    boolean orderPayReview(ConsumeDeposit consumeDeposit);
}
