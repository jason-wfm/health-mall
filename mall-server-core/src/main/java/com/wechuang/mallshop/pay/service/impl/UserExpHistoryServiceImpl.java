 ...
 */
@Service
public class UserExpHistoryServiceImpl extends BaseServiceImpl<UserExpHistoryRepository, UserExpHistory, UserExpHistoryListReq> implements UserExpHistoryService {
}
