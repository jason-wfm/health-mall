 ...
 * @since 2021-07-28
 */
public interface UserBankCardService extends IBaseService<UserBankCard, UserBankCardListReq> {
     ...
     * @return
     */
    BankRes getList(Integer userId);
     ...
     * @return
     */
    UserBankCard getUserBank(Integer userBankId, Integer userId);
     ...
     * @return
     */
    boolean addOrEditUserBank(UserBankCard userBankCard);
