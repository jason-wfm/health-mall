...
/**
 * <p>
 * 交易明细表-账户收支明细-资金流水表-账户金额变化流水 服务实现类
 * </p>
 *
 * @author Xinze
 * @since 2021-06-30
 */
@Service
public class ConsumeRecordServiceImpl extends BaseServiceImpl<ConsumeRecordRepository, ConsumeRecord, ConsumeRecordListReq> implements ConsumeRecordService {
}
