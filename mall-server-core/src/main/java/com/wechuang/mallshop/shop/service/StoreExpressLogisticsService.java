...
/**
 * <p>
 * 物流 = shop_store_express 服务类
 * </p>
 *
 * @author Xinze
 * @since 2021-05-19
 */
public interface StoreExpressLogisticsService extends IBaseService<StoreExpressLogistics, StoreExpressLogisticsListReq> {

    /**
     * 物流 添加/修改
     *
     * @param storeExpressLogistics
     * @return
     */
    boolean saveOrUpdate(StoreExpressLogistics storeExpressLogistics);
