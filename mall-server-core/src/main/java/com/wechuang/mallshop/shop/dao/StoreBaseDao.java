 ...
 */
@Mapper
public interface StoreBaseDao extends BaseMapper<StoreBase> {

    IPage<StoreStreetOutput> getNearShop(Page<StoreStreetInput> page, @Param("params") StoreStreetInput params);
