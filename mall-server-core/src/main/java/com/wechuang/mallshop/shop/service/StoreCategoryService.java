 ...
 * @since 2026-03-30
*/
public interface StoreCategoryService extends IBaseService<StoreCategory, StoreCategoryListReq> {

    /**
     * 市场分类表-树形
     * @param storeCategoryListReq
     * @return
     */
    List<StoreCategoryRes> getTree(StoreCategoryListReq storeCategoryListReq);

    /**
     * 市场分类表-通过store_category_id删除
     * @param storeCategoryId
     * @return
     */
    boolean removeById(Integer storeCategoryId);
}
