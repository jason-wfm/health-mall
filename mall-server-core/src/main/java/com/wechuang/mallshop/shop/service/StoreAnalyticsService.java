 ...
 * @since 2021-08-01
 */
public interface StoreAnalyticsService extends IBaseService<StoreAnalytics, StoreAnalyticsListReq> {
    List<StoreInfoVo> getAnalytics(List<Integer> storeIds, List<StoreInfoVo> infoVoList);

    StoreAnalytics getStoreAnalytics(Integer storeId);

    boolean saveProductAnalyticsNum(Integer storeId);
}
