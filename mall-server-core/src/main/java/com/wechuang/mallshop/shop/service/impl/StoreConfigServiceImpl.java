...
import com.wechuang.mallshop.shop.model.entity.StoreConfig;
import com.wechuang.mallshop.shop.model.req.StoreConfigListReq;
import com.wechuang.mallshop.shop.repository.StoreConfigRepository;
import com.wechuang.mallshop.shop.service.StoreConfigService;
    ...
    public Integer getNextReturnProcess(Integer storeId, Integer stateId) {
        ...
        if (CollectionUtil.isNotEmpty(processList)) {
            ...
            if (processList.size() >= index + 2) {
                ...
                //客户确认收货
                if (Objects.equals(storeId, StateCode.RETURN_PROCESS_CHECK)
                        || Objects.equals(storeId, StateCode.RETURN_PROCESS_RECEIVED)
                        || Objects.equals(storeId, StateCode.RETURN_PROCESS_REFUND)
                        || Objects.equals(storeId, StateCode.RETURN_PROCESS_RECEIPT_CONFIRMATION)) {
