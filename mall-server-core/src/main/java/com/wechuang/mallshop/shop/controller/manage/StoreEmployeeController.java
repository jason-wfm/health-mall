...
import com.wechuang.mallshop.shop.model.entity.StoreEmployee;
import com.wechuang.mallshop.shop.model.req.StoreEmployeeAddReq;
import com.wechuang.mallshop.shop.model.req.StoreEmployeeEditReq;
import com.wechuang.mallshop.shop.model.req.StoreEmployeeListReq;
 ...
 * @since 2021-08-07
 */
@Tag(name = "卖家用户表—公司员工employee-通过user id启用用户中心")
@RestController
...
public class StoreEmployeeController extends BaseController {
    ...
    @Operation(summary = "卖家用户表—公司员工employee-通过user id启用用户中心-分页列表查询", description = "卖家用户表—公司员工employee-通过user id启用用户中心-分页列表查询")
    ...
    @Operation(summary = "卖家用户表—公司员工employee-通过user id启用用户中心-通过employee_id查询", description = "卖家用户表—公司员工employee-通过user id启用用户中心-通过employee_id查询")
    ...
    @Operation(summary = "卖家用户表—公司员工employee-通过user id启用用户中心-添加", description = "卖家用户表—公司员工employee-通过user id启用用户中心-添加")
    ...
    @Operation(summary = "卖家用户表—公司员工employee-通过user id启用用户中心-编辑", description = "卖家用户表—公司员工employee-通过user id启用用户中心-编辑")
    ...
    @Operation(summary = "卖家用户表—公司员工employee-通过user id启用用户中心-通过employee_id删除", description = "卖家用户表—公司员工employee-通过user id启用用户中心-通过employee_id删除")
    ...
    @Operation(summary = "卖家用户表—公司员工employee-通过user id启用用户中心-批量删除", description = "卖家用户表—公司员工employee-通过user id启用用户中心-批量删除")
