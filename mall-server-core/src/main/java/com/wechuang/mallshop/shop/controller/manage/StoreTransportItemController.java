...
import com.wechuang.mallshop.shop.model.req.StoreTransportItemAddReq;
import com.wechuang.mallshop.shop.model.req.StoreTransportItemEditReq;
import com.wechuang.mallshop.shop.model.req.StoreTransportItemListReq;
import com.wechuang.mallshop.shop.service.StoreTransportItemService;
...
public class StoreTransportItemController extends BaseController {
    ...
    @Operation(summary = "自定义物流模板内容表-只处理区域及运费。-分页列表查询", description = "自定义物流模板内容表-只处理区域及运费。-分页列表查询")
    ...
    @Operation(summary = "自定义物流模板内容表-只处理区域及运费。-添加", description = "自定义物流模板内容表-只处理区域及运费。-添加")
    ...
    @Operation(summary = "自定义物流模板内容表-只处理区域及运费。-编辑", description = "自定义物流模板内容表-只处理区域及运费。-编辑")
    ...
    @Operation(summary = "自定义物流模板内容表-只处理区域及运费。-通过transport_item_id删除", description = "自定义物流模板内容表-只处理区域及运费。-通过transport_item_id删除")
