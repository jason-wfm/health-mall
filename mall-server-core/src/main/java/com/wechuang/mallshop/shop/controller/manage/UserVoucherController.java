...
import com.wechuang.mallshop.shop.model.req.UserVoucherAddReq;
import com.wechuang.mallshop.shop.model.req.UserVoucherEditReq;
...
public class UserVoucherController extends BaseController {
    ...
    @Operation(summary = "用户优惠券表-分页列表查询", description = "用户优惠券表-分页列表查询")
    ...
    @Operation(summary = "用户优惠券表-通过user_voucher_id查询", description = "用户优惠券表-通过user_voucher_id查询")
    ...
    @Operation(summary = "用户优惠券表-添加", description = "用户优惠券表-添加")
    ...
    @Operation(summary = "用户优惠券表-编辑", description = "用户优惠券表-编辑")
    ...
    @Operation(summary = "用户优惠券表-通过user_voucher_id删除", description = "用户优惠券表-通过user_voucher_id删除")
    ...
    @Operation(summary = "用户优惠券表-批量删除", description = "用户优惠券表-批量删除")
