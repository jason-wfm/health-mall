 ...
 * @since 2021-05-11
 */
public interface StoreTransportTypeService extends IBaseService<StoreTransportType, StoreTransportTypeListReq> {
     ...
     * 添加/修改
     *
     * @param storeTransportType
     * @return
     */
    boolean saveOrUpdateTransport(StoreTransportType storeTransportType);
}
