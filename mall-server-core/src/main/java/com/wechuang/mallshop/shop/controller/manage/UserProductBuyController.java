...
import com.wechuang.mallshop.shop.model.entity.UserProductBuy;
import com.wechuang.mallshop.shop.model.req.UserProductBuyAddReq;
import com.wechuang.mallshop.shop.model.req.UserProductBuyEditReq;
import com.wechuang.mallshop.shop.model.req.UserProductBuyListReq;
import com.wechuang.mallshop.shop.service.UserProductBuyService;
...
public class UserProductBuyController extends BaseController {
    ...
    @Operation(summary = "用户商品购买数量历史表-分页列表查询", description = "用户商品购买数量历史表-分页列表查询")
    ...
    @Operation(summary = "用户商品购买数量历史表-通过product_buy_id查询", description = "用户商品购买数量历史表-通过product_buy_id查询")
    ...
    @Operation(summary = "用户商品购买数量历史表-添加", description = "用户商品购买数量历史表-添加")
    ...
    @Operation(summary = "用户商品购买数量历史表-编辑", description = "用户商品购买数量历史表-编辑")
    ...
    @Operation(summary = "用户商品购买数量历史表-通过product_buy_id删除", description = "用户商品购买数量历史表-通过product_buy_id删除")
    ...
    @Operation(summary = "用户商品购买数量历史表-批量删除", description = "用户商品购买数量历史表-批量删除")
