...
import com.wechuang.mallshop.${package.ModuleName}.service.${entity}Service;
...
public class ${table.controllerName} {
    ...
    @Operation(summary = "${table.comment}-通过${keyAnnotationColumnName}查询", description = "${table.comment}-通过${keyAnnotationColumnName}查询")
    ...
    @Operation(summary = "${table.comment}-编辑", description = "${table.comment}-编辑")
    ...
    @Operation(summary = "${table.comment}-通过${keyAnnotationColumnName}删除", description = "${table.comment}-通过${keyAnnotationColumnName}删除")
